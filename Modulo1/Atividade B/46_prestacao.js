/**
 * F1_q46: Uma loja vende seus produtos no sistema entrada mais duas prestações, sendo a entrada maior ou igual a
...
// Início
const valor_mercadoria = Number(question('Valor da Mercadoria(R$): '))

// Processamento
const parcelas = Math.floor(valor_mercadoria / 3)
const entrada = valor_mercadoria  % 3 + parcelas

// Saída
console.log(`> Entrada = R$ ${entrada.toFixed(2)}`)
console.log(`  + 2X de = R$ ${parcelas.toFixed(2)}`)
console.log('-------------------')
